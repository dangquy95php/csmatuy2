            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <a href="{{route('gate.input')}}" class="card-title">Cổng ngày: <b class="time-now text-danger">{{ date('d-m-Y') }}</b></a>
                        <!-- <div class="modal fade" id="basicModal" tabindex="-1" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Danh sách phép</h5>
                        ...
                        <div class="w-50 d-flex justify-content-end">
                            <!-- <button type="button" class="btn-sm btn btn-primary text-right" data-bs-toggle="modal" data-bs-target="#basicModal">Xem phép</button> -->
        ...
        $.ajax({
            ...
            error: function (data) {
                if (data.status == 422) {
                    ...
                    toastr.error('Thất bại vui lòng nhập lại!');
