          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Nhập thông tin chi tiết tạo tài khoản</p>
                  </div>
                  ...
                  @csrf
                    <div class="col-12">
                      ...
                      <input type="text" name="name" value="{{old('name', @$data->name)}}" class="form-control" id="yourName" required>
                      @include('_partials.alert', ['field' => 'name'])
                    </div>

                    <div class="col-12">
                      <label for="yourEmail" class="form-label">Nhập Email</label>
                      <input type="email" name="email" value="{{old('email', @$data->email)}}" class="form-control" id="yourEmail" required>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" name="username" value="{{old('username', @$data->username)}}" class="form-control" id="yourUsername" required>
              ...
              <div class="credits">
                ...
                Thiết kế bởi <a href="">Đặng Quý</a>
              </div>
