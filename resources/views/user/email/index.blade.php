          ...
          <div class="email-wrapper wrapper">
            <div class="row align-items-stretch">
              ...
              @foreach($datas as $k => $items)
                <div class="mail-list justify-content-between">
                <div class="content">
                    <p class="sender-name text-decoration-underline" role="button" data-bs-toggle="modal" data-bs-target="#basicModal{{ str_replace(' ', '', $k) }}">Xem danh sách người nhận <i class="ri-user-add-line"></i></p>
