    ...
    selectors.forEach((item, index) => {
        ...
        function multiSelects() {
            ...
            <div class="directorist-select__label">
                ...
                <input type="text" class='directorist-select__search ${ isSearch ? 'directorist-select__search--show' : 'directorist-select__search--hide' }' type='text' class='value' placeholder='Tìm kiếm cán bộ....' />
            </div>
            ...
            function insertSearchItem () {
                item.querySelector('.directorist-select__selected-list').innerHTML = defaultValues[arraySelector].map(item => `<span class="directorist-select__selected-list--item">${item}&nbsp;&nbsp;<a href="#" data-key="${item}" class="directorist-item-remove"><i class="ri-close-fill"></i></a></span>`).join("")
            }
            ...
            button.addEventListener('click', (e) => {
                ...
                value && value.addEventListener('keyup', (event) => {     
                    ...
                    var filter = option.filter((el, index) => {     
                            ...
                            return last_text[last_text.length - 1].match(rel);
                        });
