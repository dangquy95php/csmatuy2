...
class UserImport implements ToModel, WithHeadingRow, WithStartRow, WithChunkReading, ShouldQueue, WithCalculatedFormulas
{
    /**
    ...
    */
    ...
    public function model(array $row)
    {
        try {
            if (!empty($row['stt'])) {
                $teamId = Team::where('note', $row['don_vi'])->select('id')->first();
                ...
                // $date = !empty($row['nam']) ? \PhpOffice\PhpSpreadsheet\Shared\Date::excelToDateTimeObject(@$row['nam'])->format('d/m/Y') : \PhpOffice\PhpSpreadsheet\Shared\Date::excelToDateTimeObject(@$row['nu'])->format('d/m/Y');
                // !empty($row['nam']) ? \PhpOffice\PhpSpreadsheet\Shared\Date::excelToDateTimeObject(@$row['nam']) : \PhpOffice\PhpSpreadsheet\Shared\Date::excelToDateTimeObject(@$row['nu'])->format('d/m/Y');
